...
export function BlogCard({
  ...
  return (
    <div className="bg-[#111111] rounded-lg border border-gray-800 overflow-hidden hover:border-gray-700 transition-all duration-300 group">
      ...
      <div className="p-6">
        ...
        <h3 className="text-xl font-medium mb-4 group-hover:text-[#00d2ff] transition-colors line-clamp-2">{title}</h3>
