...
export function ServiceFooter() {
  return (
    <footer className="py-16 border-t border-gray-800 bg-[#0a0a0a]">
      <div className="container mx-auto">
        <div className="grid md:grid-cols-5 gap-12 mb-12">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-6">
              <Image src="/logo.png" alt="Web3 Savannah Logo" width={32} height={32} className="rounded-full" />
              <span className="text-xl font-bold">Web3 Savannah</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/services/savannah-devs" className="text-gray-400 hover:text-white text-sm">
                  Savannah Devs
                </Link>
              </li>
              <li>
                <Link href="/services/scroll-savannah" className="text-gray-400 hover:text-white text-sm">
                  Scroll Savannah
                </Link>
              </li>
              <li>
                <Link href="/services/advisory" className="text-gray-400 hover:text-white text-sm">
                  Advisory Services
                </Link>
              </li>
              <li>
                <Link href="/services/baas-card-solutions" className="text-gray-400 hover:text-white text-sm">
                  BAAS & Card Solutions
                </Link>
              </li>
            </ul>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="bg-gray-800 border border-gray-700 rounded-md px-4 py-2 text-sm flex-1 focus:outline-none focus:ring-2 focus:ring-[#00d2ff] focus:border-transparent"
                />
