...
export default function Home() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Animated Banner */}
      <AnimatedBanner
        title="Launch Your Web3 & AI Vision—Faster, Smarter, Together"
        subtitle="From NFTs to DeFi, Web3 Savannah provides tailored, enterprise-grade governance and world-class Web3, DApps, and AI solutions—right here in Africa, with a global reach."
      >
      ...
      <section className="py-16 border-t border-gray-200 dark:border-gray-800">
        <div className="container mx-auto">
          <div className="flex items-center gap-2 mb-4">
            <div className="h-1 w-6 bg-gray-300 dark:bg-gray-700 rounded-full"></div>
            <span className="text-xs text-gray-500 dark:text-gray-400 uppercase">About Web3 Savannah</span>
          </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center border-b border-gray-200 dark:border-gray-800 pb-2">
                  <span className="text-sm text-gray-600 dark:text-gray-400">Lead Assessment Timeframe</span>
                  <span className="text-[#00d2ff]">24 Hours</span>
                </div>
                <div className="flex justify-between items-center border-b border-gray-200 dark:border-gray-800 pb-2">
                  <span className="text-sm text-gray-600 dark:text-gray-400">Development Capacity Available</span>
                ...
                <div className="flex justify-between items-center border-b border-gray-200 dark:border-gray-800 pb-2">
                  <span className="text-sm text-gray-600 dark:text-gray-400">Current Market Status</span>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Link href="/services/savannah-devs" className="group">
              <div className="bg-white dark:bg-[#111111] p-8 rounded-lg border border-gray-200 dark:border-gray-800 hover:border-[#00d2ff] transition-colors h-full">
                ...
                <h3 className="text-xl font-medium mb-2 text-gray-900 dark:text-white group-hover:text-[#00d2ff] transition-colors">
                  Savannah Devs
                </h3>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-[#111111] rounded-lg border border-gray-200 dark:border-gray-800 overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-xl font-medium mb-4 text-gray-900 dark:text-white">Web3 Savannah Hackathon</h3>
                ...
                <Button className="w-full bg-transparent hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-700 hover:border-[#00d2ff] dark:hover:border-[#00d2ff]">
                  Register Now
                </Button>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-[#111111] rounded-lg border border-gray-200 dark:border-gray-800 overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-xl font-medium mb-4 text-gray-900 dark:text-white">AI in Finance Workshop</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-[#111111] rounded-lg border border-gray-200 dark:border-gray-800 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-medium mb-4 text-gray-900 dark:text-white">
                  The Future of DeFi: Trends to Watch in 2025
                </h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm mb-6">
            ...
            <div className="bg-white dark:bg-[#111111] rounded-lg border border-gray-200 dark:border-gray-800 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-medium mb-4 text-gray-900 dark:text-white">
                  Building Scalable Smart Contracts: Best Practices
                </h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm mb-6">
            ...
            <div className="bg-white dark:bg-[#111111] rounded-lg border border-gray-200 dark:border-gray-800 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-medium mb-4 text-gray-900 dark:text-white">
                  Web3 in Africa: Opportunities and Challenges
                </h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm mb-6">
