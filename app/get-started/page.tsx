...
import { ArrowRight, Calendar, CheckCircle, FileText, MessageCircle, PhoneCall, Video } from "lucide-react"
      ...
      <section className="py-16 bg-[#0c0c0c]">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-[#111111] p-8 rounded-lg border border-gray-800 hover:border-[#00d2ff] transition-all duration-300 group">
              <div className="mb-6 text-[#00d2ff] transition-all duration-300">
                <PhoneCall size={40} />
              </div>
              <h3 className="text-xl font-medium mb-4 group-hover:text-[#00d2ff] transition-all duration-300">
                Schedule a Call
              </h3>
              <p className="text-gray-400 mb-6">
                Book a 30-minute consultation call with one of our Web3 experts to discuss your project needs.
              </p>
              <Button className="w-full bg-transparent hover:bg-gray-800 text-white border border-gray-700 group-hover:border-[#00d2ff] transition-all duration-300">
                Book a Call
              </Button>
            </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
              ...
              <form className="space-y-6">
                ...
                <div className="flex items-start gap-2">
                  <input
                    type="checkbox"
                    id="privacyPolicy"
                    className="mt-1 bg-gray-800 border border-gray-700 rounded focus:ring-[#00d2ff]"
                  />
                  <label htmlFor="privacyPolicy" className="text-sm text-gray-400">
                    I agree to the{" "}
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-medium mb-4">Why Work With Us</h3>
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-[#00d2ff] mt-0.5" />
                    <div>
                      <h4 className="font-medium">African Expertise</h4>
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-[#00d2ff] mt-0.5" />
                    <div>
                      <h4 className="font-medium">End-to-End Solutions</h4>
                      <p className="text-gray-400 text-sm">
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-[#00d2ff] mt-0.5" />
                    <div>
                      <h4 className="font-medium">Certified Professionals</h4>
                      <p className="text-gray-400 text-sm">
              ...
              <div className="bg-[#111111] p-6 rounded-lg border border-gray-800">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div className="text-gray-400 text-sm">Nairobi, Kenya</div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-[#00d2ff] flex items-center justify-center text-black mt-0.5">
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="text-gray-400 text-sm">hello@web3savannah.com</div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-[#00d2ff] flex items-center justify-center text-black mt-0.5">
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="text-gray-400 text-sm">+254 (0) 712 345 678</div>
                  </li>
                </ul>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="bg-[#111111] p-6 rounded-lg border border-gray-800">
                <h3 className="text-lg font-medium mb-3">What types of projects do you work on?</h3>
                <p className="text-gray-400 text-sm">
              ...
              <div className="bg-[#111111] p-6 rounded-lg border border-gray-800">
                <h3 className="text-lg font-medium mb-3">How long does a typical project take?</h3>
                <p className="text-gray-400 text-sm">
              ...
              <div className="bg-[#111111] p-6 rounded-lg border border-gray-800">
                <h3 className="text-lg font-medium mb-3">Do you offer support after project completion?</h3>
                <p className="text-gray-400 text-sm">
            ...
            <div className="space-y-6">
              <div className="bg-[#111111] p-6 rounded-lg border border-gray-800">
                <h3 className="text-lg font-medium mb-3">What are your payment terms?</h3>
                <p className="text-gray-400 text-sm">
              ...
              <div className="bg-[#111111] p-6 rounded-lg border border-gray-800">
                <h3 className="text-lg font-medium mb-3">Can you work with existing projects or codebases?</h3>
                <p className="text-gray-400 text-sm">
              ...
              <div className="bg-[#111111] p-6 rounded-lg border border-gray-800">
                <h3 className="text-lg font-medium mb-3">Do you serve clients outside of Africa?</h3>
                <p className="text-gray-400 text-sm">
