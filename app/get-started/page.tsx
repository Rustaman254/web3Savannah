...
import { CheckCircle, PhoneCall, FileText, Video, MessageCircle, Calendar, ArrowRight } from 'lucide-react';
...
const ProcessStep: React.FC<ProcessStepProps> = ({ number, title, description }) => (
  <div className="space-y-4">
    <div className="flex items-center gap-2">
      <span className="text-2xl font-bold text-[#00d2ff]">{number}</span>
